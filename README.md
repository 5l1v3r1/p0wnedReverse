...
* Cn33liz Invoke-x64-Meterpreter (wrapper around Invoke-Shellcode that will setup a x64 reversed https meterpreter Shell to 192.168.1.120. Works only with x64 version)
